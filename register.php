<?php
	...
	if(isset($_POST['register'])) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = "bloodonation.xyz@gmail.com";
        $mail->Password = 'donation@12345';
        $mail->Port = 587;
        $mail->SMTPSecure = "ssl"; //tls

        //Email Settings
        $mail->isHTML(true);
        $mail->setFrom('bloodonation.xyz@gmail.com');
        $mail->addAddress('chaitanyarai19@gmail.com');
        $mail->Subject = "Hello";
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                       ...
                       <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="PHONE NO." name="mobile" required>
                        </div>
                       ...
                       <div class="input-group">
						...
						<div class="input-group">
                            <input class="input--style-1" type="password" placeholder="PASSWORD" name="pswd" required>
                        </div>
