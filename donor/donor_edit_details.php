...
<head>
  <meta charset="utf-8" />
  <title>Bloodanytime | Edit Donor Details</title>
                          ...
                          <div ng-controller="widget.ContactForm.Controller" ng-init='hash = &apos;2@&apos;;actionAfterSubmission={"action":"none","url":"","target":"_self","id":""};resetAfterSubmission=false'>
                            ...
                            <form method="POST" id="wid_1555319995_sgk7l55px__form">
                              ...
                              <div class="moto-widget-contact_form-group">
                                ...
                                <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="Your name *" ng-blur="validate('name')" required ng-model-options="{ updateOn: 'blur' }" name="name" id="field_name_wid_1555319995_sgk7l55px" ng-model="register.name" />
                              ...
                              <div class="moto-widget-contact_form-group">
                                ...
                                <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="Email" name="email" id="field_email_wid_1555319995_sgk7l55px" />
                              </div>
                              <!--<div class="moto-widget-contact_form-group" id="otp">
                                <label for="checkVerify" class="moto-widget-contact_form-label">OTP *</label>
                                <a href="" id="resend" style="display:none;">resend OTP</a>
                                <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="OTP" id="checkVerify" required />
                              </div>-->
                              <div class="moto-widget-contact_form-group">
                                <label for="field_phone_wid_1555319995_sgk7l55px" class="moto-widget-contact_form-label">Phone</label>
                                <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="Phone *" ng-blur="validate('phone')" required ng-model-options="{ updateOn: 'blur' }" name="phone" id="field_phone_wid_1555319995_sgk7l55px" ng-model="message.phone" />
                              ...
                              <div class="moto-widget-contact_form-group" aria-placeholder="Select your Blood Group">
                                <select name="blood_group" id="blood_group" class="moto-widget-contact_form-field moto-widget-contact_form-select" aria-placeholder="Select your Blood Group">
                              ...
                              <div class="moto-widget-contact_form-group">
                                <label for="field_name_wid_1555319995_sgk7l55px" class="moto-widget-contact_form-label">State </label>
                                <select name="state" id="state" class="moto-widget-contact_form-field moto-widget-contact_form-select" aria-placeholder="Select your Blood Group" required>
                                  <option selected disabled>Select your state </option>
                                </select>
                                <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.name.$invalid && !contactForm.name.$pristine && !contactForm.name.emailInvalid">Field
                                  is required</span>
                              </div>
                              <div class="moto-widget-contact_form-group" aria-placeholder="Select your Blood Group" required>
                                <select name="city" id="city" class="moto-widget-contact_form-field moto-widget-contact_form-select" aria-placeholder="Select your Blood Group">
                             ...
                             <!-- <div class="moto-widget-contact_form-group">
                                <label for="field_name_wid_1555319995_sgk7l55px" class="moto-widget-contact_form-label">Address</label>
                                <input type="text" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="Your address *" ng-blur="validate('name')" required ng-model-options="{ updateOn: 'blur' }" name="address" id="field_name_wid_1555319995_sgk7l55px" ng-model="message.name" />
                                <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.name.$invalid && !contactForm.name.$pristine && !contactForm.name.emailInvalid">Field
                                  is required</span>
                              </div>-->
                              <div class="moto-widget-contact_form-group">
                                <label for="field_name_wid_1555319995_sgk7l55px" class="moto-widget-contact_form-label">Your Password</label>
                                <input type="password" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="Your Password *" ng-blur="validate('name')" required ng-model-options="{ updateOn: 'blur' }" name="password" id="field_name_wid_1555319995_sgk7l55px" ng-model="message.name" />
                                <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.name.$invalid && !contactForm.name.$pristine && !contactForm.name.emailInvalid">Field
                                  is required</span>
                              </div>
                              <div class="moto-widget-contact_form-group">
                                <label for="field_name_wid_1555319995_sgk7l55px" class="moto-widget-contact_form-label">Confirm Password</label>
                                <input type="password" class="moto-widget-contact_form-field moto-widget-contact_form-input" placeholder="Confirm Password *" ng-blur="validate('name')" required ng-model-options="{ updateOn: 'blur' }" name="confirm_password" id="field_name_wid_1555319995_sgk7l55px" ng-model="message.name" />
                                <span class="moto-widget-contact_form-field-error ng-cloak" ng-cloak ng-show="contactForm.name.$invalid && !contactForm.name.$pristine && !contactForm.name.emailInvalid">Field
                                  is required</span>
                              </div>
                              <div id="donor_registration_message"></div>
                              ...
                              <div class="moto-widget-contact_form-buttons">
                                <div class="moto-widget moto-widget-button moto-preset-default moto-preset-provider-default moto-align-left" data-preset="default" data-align="left">
                                  <input type="submit" name="register" class="moto-widget-button-link moto-size-medium" data-size="medium" value="Register">
