                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="row row-space">
                           ...
                           <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Police Employee Name</label>
                                    <input class="input--style-4" type="text" name="ename">
                                </div>
                            </div>
							<div class="col-2">
                                <div class="input-group">
                                    <label class="label">Police Employee Mobile</label>
                        ...
                        <div class="p-t-15">
							...
							<button class="btn btn--radius-2 btn--blue right" type="submit"><a href="../logout.php">Sign Out</a></button>
                        </div>
                    </form>
                </div>
            </div>
