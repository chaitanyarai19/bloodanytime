...
<html lang="en">
	<head>
	    ...
	    <title>Apna Kiranas | Products sub-category</title>
...
//{
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img style="height:300px;" src="assets/images/sliders/rice.jpg" alt="" class="img-responsive">
			</div>
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="150" height="130"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
