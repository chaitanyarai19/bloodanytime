...
<div class="login-page">
  <div class="form">
  	<b><u><h2>Apna Kiranas</h2></u></b><br>
    <form class="register-form" role="form" method="post" name="register" onSubmit="return valid();">

      <input type="text" id="fullname" name="fullname" placeholder="Full Name" required/>
      <input type="text" id="email"  name="emailid" placeholder="Email Address" required/>
...
echo htmlentities($_SESSION['errmsg']="");
?>  
      <input type="email" name="email" id="exampleInputEmail1" placeholder="username"/>
