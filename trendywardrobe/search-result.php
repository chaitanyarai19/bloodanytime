...
<html lang="en">
	<head>
	    ...
	    <title>Apna Kiranas | Products Search</title>
...
//{
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img style="height:350px;" src="assets/images/sliders/biscuit.jpg" alt="" class="img-responsive">
			</div>
                       ...
                       if(response.status == 1)
                       {
                           ...
                           $("#load_qty").load(location.href + " #load_qty");
                            $("#load_qty2").load(location.href + " #load_qty2");
                              $("#load_qty3").load(location.href + " #load_qty3");
