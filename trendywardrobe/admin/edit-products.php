...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productquantity='$productquantity',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<div class="controls">
<input type="text"    name="productquantity"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productquantity']);?>" class="span8 tip" required>
</div>
</div>
